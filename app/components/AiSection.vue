    ...
    <div class="w-full px-4 lg:px-10">
      ...
      >
        ...
        >
          ...
          <h2
            class="text-[34px] font-[600] leading-[112%] text-[#2E2E2E] lg:text-[48px] lg:leading-[132%]"
          >
            Be First to Power Your Features with DartCode AI
          </h2>

          <p
            class="text-[16px] font-[400] leading-[145%] text-[#5D5D5E] lg:text-[20px] lg:leading-[150%]"
          >
            DartCode AI is the only AI built specifically for Dart feature
            flagging. It learns from your app's live usage, optimizes rollouts
            in real time, and safeguards every release
          </p>
          ...
          <ul class="space-y-6">
            <li class="flex items-start gap-4">
              ...
              <div>
                ...
                >
                  Forecast which users will adopt features fastest
                </p>
              </div>
            </li>
            ...
            <li class="flex items-start gap-4">
              ...
              <div>
                ...
                <p
                  class="mt-1 text-[16px] font-[400] leading-[132%] text-[#676669]"
                >
                  Automatic rollout adjustments based on live results.
                </p>
              </div>
            </li>
            ...
            <li class="flex items-start gap-4">
              ...
              <div>
                ...
                <p
                  class="mt-1 text-[16px] font-[400] leading-[132%] text-[#676669]"
                >
                  Early anomaly detection and instant rollback cues
                </p>
              </div>
            </li>
          </ul>
        ...
        >
          ...
          >
            ...
            <img
              src="/ibm.png"
              alt="IBM"
              class="col-span-2 mx-auto h-10 w-auto object-contain lg:col-span-1 lg:h-[60px] lg:justify-self-start"
            />
          </div>
        </div>
      </section>
