...
<template>
  ...
  >
    ...
    >
      ...
      />
      <div
        class="flex flex-col gap-[4px] text-left lg:h-[43px]"
      >
        <p
          class="font-jakarta text-[16px] font-[700] leading-[132%] text-[#121316]"
        >
          {{ name }}
        </p>
        <p
          class="text-[14px] font-[400] leading-[125%] text-[#121316]"
        >
          {{ role }}
        </p>
      </div>
